...
- [Unit 6 Team Project – *Airbnb Price Prediction and Market Segmentation in New York City*]({{ site.baseurl }}/projects/module-3-unit-6-team-project)
- [Unit 11 Individual Project – *Object Recognition with CNNs*]({{ site.baseurl }}/projects/module-3-unit-11-individual-project)
- [Project Evaluation – Comparison of Team and Individual Projects]({{ site.baseurl }}/projects/module-3-project-evaluation)

## Submissions
- [Development Team Project: Final Report (PDF)]({{ site.baseurl }}/assets/pdf/project-report.pdf)
- [Development Individual Project: Presentation Slides (PDF)]({{ site.baseurl }}/assets/pdf/presentation.pdf)
- [End of Module Assignment: e-Portfolio Submission (Reflective Piece, PDF)]({{ site.baseurl }}/assets/pdf/reflective-piece.pdf)
