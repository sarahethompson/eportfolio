...
module: module-3
module_title: "Module 3: Machine Learning"
order: 9
summary: "Deep learning has revolutionised artificial intelligence by enabling highly complex pattern recognition across different domains, from image processing to natural language understanding."
---
...
## Notes
[Notes on CNN]({{ site.baseurl }}/modules/module-3/notes/unit-10-CNN-notes)
...
## Artefacts
- <a href="{{ site.baseurl }}/assets/html/module-3/unit-9-CNN-model-activity.html" target="_blank" rel="noopener noreferrer">CNN Model Activity (HTML view)</a> | [Download Notebook]({{ site.baseurl }}/assets/notebooks/module-3/unit-9-CNN-model-activity.ipynb)
