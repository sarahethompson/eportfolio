...
order: 12
summary: "The so-called 'smartization' of industries, often referred to as Industry 4.0, represents a paradigm shift driven by artificial intelligence, automation, and machine learning."
---
...
## Notes
[Notes on The Future of Machine Learning]({{ site.baseurl }}/modules/module-3/notes/unit-12-notes)
...
## Artefacts
- [e-Portfolio Reflective Piece (PDF)]({{ site.baseurl }}/assets/pdf/reflective-piece.pdf)
