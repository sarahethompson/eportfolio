---
layout: page
title: "Unit 6 Team Project: Airbnb Price Prediction and Market Segmentation"
description: "Applied ML techniques to predict Airbnb prices and segment NYC market using regression, ensemble models, and clustering"
img: # Optional: Add project thumbnail later
importance: 1
category: module-3
---
...
-  [Final Team Submission – *Airbnb Price Prediction and Segmentation in New York City* (PDF)]({{ site.baseurl }}/assets/pdf/project-report.pdf)
-  [Team Meeting Notes – Week 4 (PDF)]({{ site.baseurl }}/assets/pdf/unit-4-meeting-notes.pdf)
-  [Team Meeting Notes – Week 6 (PDF)]({{ site.baseurl }}/assets/pdf/unit-6-meeting-notes.pdf)
