---
layout: page
title: "Unit 11 Individual Project: Object Recognition with CNNs"
description: "Explored object recognition using deep learning, comparing custom CNN and VGG16 transfer learning on CIFAR-10 dataset"
...
- [View Presentation Slides (PDF)]({{ site.baseurl }}/assets/pdf/presentation.pdf)
- [Read Transcript (PDF)]({{ site.baseurl }}/assets/pdf/transcript.pdf)
